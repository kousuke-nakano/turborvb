...
# copy makefuns0
cp makefun0.f90        ../../src/c_adjoint_forward/
cp makefun0_b.f90      ../../src/c_adjoint_backward/
cp makefun0_pbc.f90    ../../src/c_adjoint_forward/
cp makefun0_pbc_b.f90  ../../src/c_adjoint_backward/
cp makefun0_bump.f90   ../../src/c_adjoint_forward/
...
rm makefun_b.f90
rm makefun_pbc.f90
rm makefun_pbc_b.f90
rm makefun_bump.f90
rm makefun_bump_b.f90

rm makefun0.f90
rm makefun0_b.f90
rm makefun0_pbc.f90
rm makefun0_pbc_b.f90
rm makefun0_bump.f90
rm makefun0_bump_b.f90
