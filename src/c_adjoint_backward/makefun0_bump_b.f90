...
SUBROUTINE makefun0_bump_b (iopt,iocc,indt,typec,indpar,indorb,indshell,nelskip,z,zb,dd,ddb,r,rb,rmu,rmub,distp,distpb,iflagnorm_fake,c)
...
! user-defined cutoff for bump orbitals (see file bump_orbitals_new.f90)
  INTEGER :: iopt, indt, i, k, nelskip, indpar, iocc(*), indorbp, indorb  , indshell, indshellp, ic, iflagnorm_fake, indparp, npower, typec
  REAL*8 :: z(nelskip, 0:*), dd(*), rmu(3, 0:0), r(0:0), distp(  0:0, 20), peff, fun, fun0, fun2, rp1, rp2, rp3, dd1, dd2, dd3, dd4  , dd5, c, dsqrt, funp, fun2p, fun0z, funz, fun2z, peff2, arg, c0, c1,   cost, cut, cost_fd
  REAL*8 :: zb(nelskip, 0:*), ddb(*), rmub(3, 0:0), rb(0:0),   distpb(0:0, 20), funb, fun0b, fun2b, rp1b, rp2b, rp3b, dd1b, cb,   fun0zb, funzb, fun2zb, costb, cost_fdb
  INTEGER :: branch
  REAL*8 :: temp3
...
&        temp74b6
 ...
 250  CALL POPREAL8(adr8ibuf,adr8buf,cost)
  ...
  CASE DEFAULT
    distpb = 0.0_8
  END SELECT
END SUBROUTINE makefun0_bump_b