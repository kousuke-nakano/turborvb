...
SUBROUTINE makefun0_b (iopt,indt,typec,indpar,indorb,indshell,nelskip,z,zb,dd,ddb,zeta,r,rb,rmu,rmub,distp,distpb,iflagnorm_unused,cr)
...
! TAPENADE adBuffer vars
  ...
  real*8  :: adr8buf(1024)
! ---
  INTEGER :: iopt, indt, i, k, nelskip, indpar, indorbp, indorb,   indshell, indshellp, ic, iflagnorm_unused, indparp, npower, typec
! up to i
  REAL*8 :: z(nelskip, 0:*), dd(*), zeta(*), rmu(3, 0:0), r(0:0  ), distp(0:0, 20), peff, fun, fun0, fun2, rp1, rp2, rp3, rp4, rp5  , rp6, rp7, rp8, dd1, dd2, dd3, dd4, dd5, c, cr, funp, fun2p, peff2,   arg, c0, c1, cost, zv(6), yv(6), xv(6), r2, r4, r6
  REAL*8 :: zb(nelskip, 0:*), ddb(*), rmub(3, 0:0), rb(0:0),   distpb(0:0, 20), peffb, funb, fun0b, fun2b, rp1b, rp2b, rp3b, rp4b  , rp5b, rp6b, rp8b, dd1b, dd2b, dd3b, dd4b, dd5b, cb, funpb, fun2pb,   peff2b, argb, c0b, c1b, costb, zvb(6), yvb(6), xvb(6), r2b, r4b, r6b
  INTEGER :: branch
  INTEGER :: ad_from
  INTEGER :: ad_to
  REAL*8 :: temp3
